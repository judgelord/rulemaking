...
```{r comments-support-vs-oppose, fig.height=3, fig.width=6}
d %>% 
...
d %>% 
  filter(year > 2005, !is.na(position), position != "support and oppose") %>% 
...
`r d$organization[which(d$numberOfCommentsReceived > 99 & !is.na(d$organization))]`
