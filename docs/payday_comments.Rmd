...
Since Steve is doing similar work with SEC data, we are trying to identify standard data formats to allow for plug-and-play analysis. 

Token matches stored as Run Length Encoding take up about half the space as a logical vector of token matches and can easily be converted back.
