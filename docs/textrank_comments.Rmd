...
-The textrank comment summaries will explain why an organization is in support or in opposition.  
-Generated summaries capture changes an organization would like to see.   
-The hand coded summary contains the ask and the generated summary contains and explanation of that ask.
...
-Function removes agency name from Textrank.
-Typically this change swaps out one sentence in the summary.   
...
Things to consider:  
- Will want to replace modified sentences with complete sentences  
