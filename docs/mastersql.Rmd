...
## Number of Observations `r nrow(action)`
...
## Number of Docket IDs `r nrow(docketids)`
...
## Number of docket IDs in CFPB `r nrow(cfpb)`
...
## Total Number of Titles `r nrow(titles)`
...
## Number of titles in CFPB `r nrow(titles)`
