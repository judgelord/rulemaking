...
#Install Google Sheets and Drive Package 
...
# Authenticate
gs4_auth(email = "kmagana@umich.edu")
drive_auth(email = "kmagana@umich.edu")
...
duplicates <- d %>% 
  ...
  filter(n>1, comment_type != "elected" # excluding split electeds 
         ) %>% 
